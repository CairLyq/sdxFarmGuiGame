!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.io=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
    ...
    Manager.prototype.packet = function(packet){
        ...
        } else { // change packet to the queue
...
// persist
    ...
    (function (global){
        ...
        function JSONPPolling (opts) {
            ...
            // change callback to jsonp global
            var self = this;
    ...
    Polling.prototype.onData = function(data){
        ...
        if ('closed' != this.readyState) {
            ...
            if ('open' == this.readyState) {
                ...
                debug('ignoring poll - transport boardState "%s"', this.readyState);
            }
        }
    };
 ...
 * @api public
    ...
    function encodeAsBinary(obj, callback) {
        ...
        function writeEncoding(bloblessData) {
            ...
            buffers.unshift(pack); // change packet info to beginning of data list
    ...
    ;(function (window) {
        ...
        if (!has("json")) {
            ...
            if (!has("json-stringify")) {
                // Internal: A map of controller characters and their escaped equivalents.
                var Escapes = {
                    92: "\\\\",
                    34: '\\"',
                    8: "\\b",
                ...
                // Internal: Double-quotes a string `value`, replacing all ASCII controller
                ...
                var quote = function (value) {
                    ...
                    for (; index < length; index++) {
                        ...
                        // If the character is a controller character, append its Unicode or
            ...
            if (!has("json-parse")) {
                ...
                // Internal: A map of escaped controller characters and their unescaped
                // equivalents.
                var Unescapes = {
                    92: "\\",
                    34: '"',
                ...
                // Internal: Stores the parser boardState.
                var Index, Source;

                // Internal: Resets the parser boardState and throws a `SyntaxError`.
                var abort = function() {
                    Index = Source = null;
                    throw SyntaxError();
                };
                        ...
                        switch (charCode) {
                            ...
                            case 34:
                                ...
                                for (value = "@", Index++; Index < length;) {
                                    charCode = source.charCodeAt(Index);
                                    if (charCode < 32) {
                                        // Unescaped ASCII controller characters (those with a code unit
                                        // less than the space character) are not permitted.
                                        abort();
                                    } else if (charCode == 92) {
                                        // A reverse solidus (`\`) marks the beginning of an escaped
                                        // controller character (including `"`, `\`, and `/`) or Unicode
                                        // escape sequence.
                                        charCode = source.charCodeAt(++Index);
                                        switch (charCode) {
                                            case 92: case 34: case 47: case 98: case 116: case 110: case 102: case 114:
                                            // Revive escaped controller characters.
