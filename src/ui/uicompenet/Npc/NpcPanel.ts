...
module game{
    ...
    export class NpcPanel extends egret.gui.SkinnableComponent implements IPanel
    {
        ...
        {
            if(this.typeFont){
                this.typeFont.update(this._message);
            }else{
        ...
        public partAdded(partName:string, instance:any):void{
            ...
            if(instance == this.contentGroup){
                ...
                //显示任务说明
                this.explainLabel.text = this._data.data.exp;
